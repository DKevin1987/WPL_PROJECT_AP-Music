...
const addPlaylistBevestiging = document.querySelector(
  ".addPlaylistBevestiging",
);
//
...
const likeToegevoegdBevestigingEl = document.querySelector(
  ".likeToegevoegdBevestiging",
);
const likeDeleteBevestigingEl = document.querySelector(
  ".likeDeleteBevestiging",
);
const buttonYes = likeAddMeldingEl.querySelector(".buttonYes");
const buttonNo = likeAddMeldingEl.querySelector(".buttonNo");
const likeMeldingButtonEl =
  likeAddMeldingEl.querySelector(".likeMeldingButton");
...
function addPlaylist() {
  ...
  addToPlaylistMelding
    .querySelector(".buttonYes")
